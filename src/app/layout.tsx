...
export const metadata: Metadata = {
  ...
  keywords: ['foundation', 'non-profit', 'charity', 'community development', 'sustainability', 'education', 'clean water', 'volunteer'],
  openGraph: {
    type: 'website',
    siteName: 'GlobalRoots Foundation',
    images: [{ url: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=1200&q=80' }],
  },
};
