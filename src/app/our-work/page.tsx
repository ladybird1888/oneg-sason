...
const programs = [
  {
    ...
    impact: ['50K+ meals served', '3,200+ food distributions', '2,800+ families supported'],
  ...
  },
  {
    ...
    impact: ['1,200+ patients supported', '50+ medical outreaches', 'Partnerships with local clinics'],
  ...
  },
  {
    ...
    impact: ['100+ missionaries supported', '50+ outreach initiatives', '20+ faith-based community programs'],
