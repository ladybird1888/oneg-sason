...
import { Heart, Users, Building2, Star, CheckCircle, ArrowRight, Handshake } from 'lucide-react';
    ...
    <div className="pt-20">
      ...
      <section className="relative py-24 bg-green-900 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          <p className="text-yellow-400 uppercase tracking-widest text-sm font-medium mb-4">Take Action</p>
          <h1 className="font-display text-5xl sm:text-6xl font-bold mb-6">Get Involved</h1>
          <p className="text-green-200 text-xl max-w-2xl mx-auto leading-relaxed">
            There are many ways to join the GlobalRoots family — choose the path that resonates with you.
          </p>
          {/* Quick nav */}
      ...
      <section id="donate" className="py-20 bg-white scroll-mt-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-yellow-600 uppercase tracking-widest text-sm font-semibold mb-2">Give Today</p>
            <h2 className="font-display text-4xl font-bold text-green-900 mb-3">Make a Donation</h2>
            <p className="text-gray-600">Every dollar goes directly to programs that transform lives.</p>
          </div>
          ...
          <div className="bg-amber-50 rounded-3xl p-8 shadow-sm">
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6 text-sm text-green-800">
              💡 <strong>${customAmount || donationAmount || 100}</strong> {donationType === 'monthly' ? '/month ' : ''} can{' '}
              {(customAmount ? parseInt(customAmount) : donationAmount || 100) >= 500
                ? 'fund a full clean water installation for a family of five.'
                : (customAmount ? parseInt(customAmount) : donationAmount || 100) >= 100
            ...
            >
              <Heart size={20} />
              Donate {customAmount ? `$${customAmount}` : donationAmount ? `$${donationAmount}` : ''} {donationType === 'monthly' ? 'Monthly' : 'Now'}
            </button>
            <p className="text-center text-xs text-gray-500 mt-3">🔒 Secure payment · Tax-deductible · All currencies accepted</p>
          </div>
        </div>
      </section>
      ...
      <section id="volunteer" className="py-20 bg-amber-50 scroll-mt-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-yellow-600 uppercase tracking-widest text-sm font-semibold mb-2">Give Your Time</p>
            <h2 className="font-display text-4xl font-bold text-green-900 mb-3">Volunteer With Us</h2>
            <p className="text-gray-600">Join 35,000+ volunteers making a daily difference around the world.</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm">
            {submitted === 'volunteer' ? (
              <div className="text-center py-10">
                ...
                <h3 className="font-display text-2xl font-bold text-green-900 mb-2">Application Received!</h3>
                <p className="text-gray-600">Our volunteer coordinator will reach out within 2 business days.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit('volunteer')} className="space-y-5">
                ...
                <div>
                  ...
                  <input type="text" className="input-field" placeholder="Lagos, Nigeria" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-3">Areas of Interest</label>
                  <div className="grid grid-cols-2 gap-2">
                    {volunteerRoles.map((role) => (
                      <label key={role} className="flex items-center gap-2 p-3 rounded-xl border cursor-pointer hover:bg-green-50 transition-colors group">
                        <input
                          type="checkbox"
                        ...
                        />
                        <span className="text-sm text-gray-700 group-hover:text-green-700">{role}</span>
                      </label>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea rows={4} className="input-field resize-none" placeholder="Tell us about yourself and why you want to volunteer..." />
                </div>
                <button type="submit" className="btn-green w-full py-4 rounded-xl text-white font-bold text-lg flex items-center justify-center gap-2">
                  <Users size={20} />
                  Submit Application
                </button>
              </form>
      ...
      <section id="partnership" className="py-20 bg-white scroll-mt-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-yellow-600 uppercase tracking-widest text-sm font-semibold mb-2">Collaborate</p>
            <h2 className="font-display text-4xl font-bold text-green-900 mb-3">Partner With Us</h2>
            <p className="text-gray-600">We welcome partnerships with NGOs, corporations, governments, and academic institutions.</p>
          </div>
          ...
          <div className="bg-amber-50 rounded-3xl p-8 shadow-sm">
            {submitted === 'partnership' ? (
              <div className="text-center py-10">
                <CheckCircle size={50} className="text-green-500 mx-auto mb-4" />
                <h3 className="font-display text-2xl font-bold text-green-900 mb-2">Inquiry Submitted!</h3>
                <p className="text-gray-600">Our partnerships team will respond within 3 business days.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit('partnership')} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" className="input-field" placeholder="Head of CSR" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Email Address *</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Area of Partnership Interest</label>
                  <select className="input-field">
                ...
                <div>
                  ...
                  <textarea rows={5} required className="input-field resize-none" placeholder="Describe your organization's goals and how you envision partnering with GlobalRoots..." />
                </div>
                <button type="submit" className="btn-green w-full py-4 rounded-xl text-white font-bold text-lg flex items-center justify-center gap-2">
                  <Building2 size={20} />
                  Submit Inquiry
